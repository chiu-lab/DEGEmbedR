...
You can test:
- Built-in biological processes and pathways 
...
```r
# Example DEG list: NeST: 79 (ATM-Dependent DNA Repair)
...
```r
# Example DEG list: NeST: 105 (Ubiquitin Regulation of p53 Activity)
